...
# Duckietown Specific
from learning.reinforcement.pytorch.a3c.experiments.discrete_gru_a3 import a3c_cnn_discrete_gru as a3c
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_steps", default=15_000_000, type=int)  # Max time steps to run environment for
    ...
    parser.add_argument('--experiment_name', type=str, default='a3c-disc-gru-a3')
