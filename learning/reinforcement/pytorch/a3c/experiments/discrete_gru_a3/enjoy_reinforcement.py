...
# Duckietown Specific
import gym
from learning.reinforcement.pytorch.a3c.experiments.discrete_gru_a9 import a3c_cnn_discrete_gru as a3c
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-file', type=str,
                        default='2019-07-10_20-14-24_a3c-disc-duckie_a9-final.pth')  # Name of the model file
